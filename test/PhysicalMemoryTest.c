...
static void PhysicalMemoryRegionTest_initialize() {
...
static void PhysicalMemoryRegionTest_add() {
    PhysicalMemoryRegion region;
...
static void PhysicalMemoryRegionTest_remove() {
    PhysicalMemoryRegion region;
    PhysicalMemoryRegion_initialize(&region, frameNumber(10), frameNumber(30));
    Frame frames[30];
    memzero(frames, sizeof(frames));
...
static void PhysicalMemoryTest_add() {
    Frame frames[30];
    memzero(frames, sizeof(frames));
...
static void PhysicalMemoryTest_addUnaligned() {
    Frame frames[30];
    memzero(frames, sizeof(frames));
    PhysicalMemoryRegion_initialize(&PhysicalMemory_regions[0], frameNumber(0),  frameNumber(10));
    PhysicalMemoryRegion_initialize(&PhysicalMemory_regions[1], frameNumber(15), frameNumber(20));
...
static void PhysicalMemoryTest_remove() {
    Frame frames[30];
    memzero(frames, sizeof(frames));
    PhysicalMemoryRegion_initialize(&PhysicalMemory_regions[0], frameNumber(0),  frameNumber(10));
    PhysicalMemoryRegion_initialize(&PhysicalMemory_regions[1], frameNumber(15), frameNumber(20));
...
static void PhysicalMemoryTest_removeUnaligned() {
    Frame frames[30];
    memzero(frames, sizeof(frames));
    PhysicalMemoryRegion_initialize(&PhysicalMemory_regions[0], frameNumber(0),  frameNumber(10));
    PhysicalMemoryRegion_initialize(&PhysicalMemory_regions[1], frameNumber(15), frameNumber(20));
...
/******************************************************************************
 * PhysicalMemory initialization from Multiboot
 ******************************************************************************/

static void PhysicalMemoryTest_initializeFromMultibootV1() {
    Frame frames[30];
    memzero(frames, sizeof(frames));
...
void PhysicalMemoryTest_run() {
    RUN_TEST(PhysicalMemoryRegionTest_initialize);
    RUN_TEST(PhysicalMemoryRegionTest_add);
    RUN_TEST(PhysicalMemoryRegionTest_remove);
    ...
    RUN_TEST(PhysicalMemoryTest_add);
    RUN_TEST(PhysicalMemoryTest_addUnaligned);
    RUN_TEST(PhysicalMemoryTest_remove);
    RUN_TEST(PhysicalMemoryTest_removeUnaligned);
    ...
    RUN_TEST(PhysicalMemoryTest_initializeFromMultibootV1);
}
